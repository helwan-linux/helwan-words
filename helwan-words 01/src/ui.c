...
static void new_game(AppUI *ui)
{
    ...
    gboolean loaded =
        game_load_words(ui->game, filename);
...
static void on_new_game_clicked(GtkButton *button,
                                gpointer user_data)
{
    (void)button;
...
static void on_language_changed(GtkComboBoxText *combo,
                                gpointer user_data)
{
    AppUI *ui = user_data;
...
static void update_ui(AppUI *ui)
{
    ...
    guint remaining =
        game_get_remaining_guesses(ui->game);
