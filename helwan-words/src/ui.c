...
#define INSTALLED_ICON_PATH \
    "/usr/share/icons/hicolor/512x512/apps/helwan-words.png"

#define LOCAL_ICON_PATH \
    "data/icons/helwan-words.png"

#define INSTALLED_CSS_PATH \
    "/usr/share/helwan-words/helwan-words.css"

#define LOCAL_CSS_PATH \
    "resources/helwan-words.css"
...
static void load_css(void)
{
    ...
    if (g_file_test(
        ...
        g_warning(
            "Could not find Helwan Words CSS file."
        );
    ...
    GameLanguage language)
{
    ...
    /*
     * Fallback for running directly from
    ...
    AppUI *ui)
{
    ...
    if (g_file_test(
        ...
        g_warning(
            "Could not find Helwan Words icon."
        );
    ...
    AppUI *ui)
{
    ...
    } else if (ui->language == GAME_LANG_ES) {
...
void ui_create(GtkApplication *app)
{
    ...
    /*
     * Load the icon from the local source tree
     * during development, or from /usr/share
     * after installation.
     */
    set_window_icon(ui);
    ...
    /*
     * Load CSS before showing the window.
     */
    load_css();
